...
if ( have_posts() ) :
	...
	$hero_excerpt = has_excerpt() ? get_the_excerpt() : '';
	...
	<main class="threew-shop">
		...
		<section class="threew-shop__hero">
			...
			<?php if ( $hero_excerpt ) : ?>
				<p class="threew-shop__hero-excerpt"><?php echo esc_html( $hero_excerpt ); ?></p>
			<?php endif; ?>
