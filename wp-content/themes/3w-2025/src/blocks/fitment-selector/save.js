...
export default function save( { attributes } ) {
	...
	return (
		<div { ...useBlockProps.save( { className: 'threew-fitment-block' } ) }>
			...
			<div className="threew-fitment-block__progress" aria-hidden="true">
				<div
					className="threew-fitment-progress__step is-active"
					data-fitment-step="year"
				>
					<span className="threew-fitment-progress__index">1</span>
				...
				>
					<span className="threew-fitment-progress__index">2</span>
					<span className="threew-fitment-progress__label">
						{ 'Manufacturer' }
					</span>
				</div>
				...
				>
					<span className="threew-fitment-progress__index">3</span>
					<span className="threew-fitment-progress__label">
						{ 'Model' }
					</span>
				</div>
				...
				>
					<span className="threew-fitment-progress__index">4</span>
					<span className="threew-fitment-progress__label">
						{ 'Trim' }
					</span>
				</div>
			...
			<div
				...
				role="group"
				aria-label="Vehicle fitment selector"
			>
				<div
